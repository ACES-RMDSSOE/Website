...
//List of commands
const COMMANDS = {
  aces: 'The page you want to visit does not exist, or it may have been deleted, or the wrong address was entered. To see the commands, enter the word <span class="red"> commands</span>',
  exit: "",
  report:
    "<span class='green'>This page report has been successfully sent to support.</span>",
  commands:
    'List of commands: <span class="red"> aces</span> , <span class="red"> report</span> ,<span class="red"> exit</span>\n',
  cls: "",
}
